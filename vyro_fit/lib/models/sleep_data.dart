...
class SleepData {
  ...
  /// Schlafstunden als Dezimalzahl (z.B. 6.9)
  double get totalHours => totalDuration.inMinutes / 60;

  /// Prozentuale Verteilung der Schlafphasen (0.0 – 1.0)
  ...
  /// Schlaf-Score 0-100 (vereinfacht – Phase 4 SleepScoreCalculator macht es genauer)
  int get score {
